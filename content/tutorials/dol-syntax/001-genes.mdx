...
In DOL, **genes** are the fundamental building blocks of your ontology. A gen is a type definition that describes the structure of a concept in your domain. In v0.3.0, genes are defined using the `pub type` syntax.
