...
description: "Write self-documenting specifications with structured comments and semantic documentation"
track: "dol-syntax"
tutorial: 6
duration: "15 min"
objectives:
  - "Understand DOL's documentation philosophy"
  - "Write exegesis comments for types and fields"
  - "Document traits, constraints, and systems"
...
DOL treats documentation as a **first-class concern**. The term "exegesis" (critical explanation or interpretation) reflects DOL's philosophy: specifications should explain themselves. Well-documented specs serve as both technical reference and domain knowledge base.
...
Add exegesis comments before type definitions:
...
---
--- This constraint encodes core business rules for the order
...
Use markdown-style sections in exegesis:
...
- Constraint rules with explanations
...
Document this type with comprehensive exegesis:
...
- **Comment syntax** - single line, multi-line, and exegesis
- **Semantic tags** - @since, @see, @invariant, @deprecated
- **Documenting all constructs** - types, traits, constraints, systems
- **Best practices** - document intent, not implementation

## Next Steps

Continue learning with the v0.3.0 syntax features:

<NextTutorial
  title="v0.3.0 New Syntax"
  href="/tutorials/dol-syntax/007-v030-syntax"
  description="Learn the type keyword, extends clause, val/var bindings, and HIR architecture"
/>
...
1. **Genes/Types** - Defining structured data with `pub type`
...
4. **Constraints** - Enforcing invariants with `forall` and rules
5. **Evolution** - Managing version changes with `evolves`
6. **Exegesis** - Writing self-documenting specifications
7. **v0.3.0 Syntax** - Using `type`, `extends`, `val`/`var`, and understanding HIR
