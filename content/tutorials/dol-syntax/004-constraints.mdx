...
description: "Enforce invariants with rule declarations, forall quantifiers, and validation constraints"
track: "dol-syntax"
tutorial: 4
duration: "20 min"
objectives:
  - "Define rules for business constraints"
  - "Use forall quantifiers for collection validation"
  - "Write compound rule expressions"
  - "Apply rules to types and systems"
tags:
  - "rules"
  - "validation"
  - "invariants"
...
Rules in DOL define **invariants** - constraints that must always hold true. They enable specification-driven validation, ensuring your domain model enforces business rules at the specification level.

## Learning Objectives

By the end of this lesson, you will be able to:

- Define rules with business constraints
- Use `forall` quantifiers for collection validation
- Write compound rule expressions
- Apply rules to types and systems
...
Rules declare constraints that must hold:
...
- **Constraints**: Each order must have items and a correct total

<Tip type="info">
Rules are declarative assertions. They describe *what must be true*, not *how to make it true*.
</Tip>
...
Rules support rich expressions:

### Comparison Operators

```dol
rule AgeRestrictions {
...
Rules for financial operations:

```dol
mod finance.rules @ 0.8.1

rule ValidTransaction {
...
Rules can apply to entire systems:

```dol
mod system.rules @ 0.8.1
...
Define rules for a library system:
...
- **Rule declaration** with named constraints
- **forall quantifiers** for collection validation
- **Logical operators** for compound conditions
- **Domain-specific rules** for orders, users, inventory
- **System-level rules** for architecture validation
...
<NextTutorial
  ...
  description="Learn to manage type changes across versions with evo declarations"
/>
