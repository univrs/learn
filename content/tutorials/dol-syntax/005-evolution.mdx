...
evolves OrderV1 > OrderV2 @ 2.0.0 {
    ...
    => price_cents: UInt64 to price: Decimal {
...
evolves ProductV3 > ProductV4 @ 3.0.0 {
    ...
    => price: Float64 to pricing: PricingInfo {
...
evolves DataV1 > DataV2 @ 2.0.0 {
    ...
    => old_int: Int32 to new_int: Int64 { old_int.to_int64() }
}
```
