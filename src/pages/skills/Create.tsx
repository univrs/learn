  ...
  return (
    <>
      ...
      <section className="py-12" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>Quick Start</h2>
...
EOF`}
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>Directory Structure</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card">
              <div className="flex items-center gap-2 mb-4">
                <FolderOpen className="w-5 h-5" style={{ color: 'var(--spore-purple)' }} />
                <h3 className="font-semibold" style={{ color: 'var(--text-primary)' }}>Minimal (Required)</h3>
              </div>
    ...
    └── SKILL.md`}
            ...
            <div className="card">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold" style={{ color: 'var(--text-primary)' }}>Full-Featured</h3>
              </div>
              <pre className="text-sm font-mono" style={{ color: 'var(--soft-gray)' }}>
{`~/.claude/skills/
└── my-skill/
    ...
    └── docs/`}
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>YAML Frontmatter</h2>
...
---`}
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="card">
              <h4 className="font-semibold mb-2" style={{ color: 'var(--glow-cyan)' }}>name</h4>
            ...
            <div className="card">
              <h4 className="font-semibold mb-2" style={{ color: 'var(--glow-gold)' }}>description</h4>
              <ul className="text-sm space-y-1" style={{ color: 'var(--soft-gray)' }}>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>Skill Locations</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card" style={{ borderLeft: '4px solid var(--spore-purple)' }}>
              <h3 className="font-semibold mb-3" style={{ color: 'var(--spore-purple)' }}>Personal Skills</h3>
            ...
            <div className="card" style={{ borderLeft: '4px solid var(--glow-cyan)' }}>
              <h3 className="font-semibold mb-3" style={{ color: 'var(--glow-cyan)' }}>Project Skills</h3>
              <code className="text-sm block mb-3" style={{ color: 'var(--soft-gray)' }}>.claude/skills/</code>
              <ul className="text-sm space-y-1" style={{ color: 'var(--text-secondary)' }}>
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>Validation Checklist</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
