  ...
  return (
    <>
      ...
      <section className="py-12" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-2xl font-light" style={{ color: 'var(--text-primary)' }}>Progressive Disclosure</h2>
          </div>
          ...
          <div className="space-y-4">
            <div className="card" style={{ borderLeft: '4px solid var(--glow-cyan)' }}>
              <div className="flex justify-between items-start mb-2">
                <h3 className="font-normal" style={{ color: 'var(--glow-cyan)' }}>Level 1: Metadata</h3>
            ...
            <div className="card" style={{ borderLeft: '4px solid var(--glow-gold)' }}>
              <div className="flex justify-between items-start mb-2">
                <h3 className="font-normal" style={{ color: 'var(--glow-gold)' }}>Level 2: Quick Start</h3>
            ...
            <div className="card" style={{ borderLeft: '4px solid var(--spore-purple)' }}>
              <div className="flex justify-between items-start mb-2">
                <h3 className="font-normal" style={{ color: 'var(--spore-purple)' }}>Level 3: Full Content</h3>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-light mb-6" style={{ color: 'var(--text-primary)' }}>Required Fields</h2>
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-light mb-6" style={{ color: 'var(--text-primary)' }}>Recommended Content Structure</h2>
...
Common issues.`}
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-light mb-6" style={{ color: 'var(--text-primary)' }}>Best Practices</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.title} className="p-4 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                <h4 className="font-normal text-sm mb-1" style={{ color: 'var(--spore-purple)' }}>{item.title}</h4>
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-light mb-6" style={{ color: 'var(--text-primary)' }}>Complete Example</h2>
          <div className="rounded-xl overflow-hidden" style={{ backgroundColor: 'var(--bg-tertiary)', border: '1px solid var(--border-subtle)' }}>
            <pre className="p-6 text-sm font-mono overflow-x-auto" style={{ color: 'var(--spore-purple)' }}>
{`---
