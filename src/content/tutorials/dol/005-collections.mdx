...
```dol
// Create a map
var scores: Map<string, i64> = Map.new()
...
- `Vec<T>` is an ordered sequence with `push`, `len`, `get`
...
pub fun process_nodes(nodes<Vec<Node>) -> i64 {
