...
```dol
val success: Result<Int64, String> = Ok(42)
val failure: Result<Int64, String> = Err("not found")
...
```dol
// Option to Result
val maybe: Option<Int64> = Some(42)
val result: Result<Int64, String> = maybe.ok_or("No value found")

// Result to Option
val res: Result<Int64, String> = Ok(42)
val opt: Option<Int64> = res.ok()  // Some(42)

val err: Result<Int64, String> = Err("failed")
val none: Option<Int64> = err.ok()  // None
```
